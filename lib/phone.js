...
var PHONE_REGEX = /^\(?([0-9]{3})\)?[-.●,/\s/]?([0-9]{3})[-.●,/\s/]?([0-9]{4})$/;
/**
 ...
 * @description Given a string, returns true if string is in email format using RegExp. This will consiste of 10 digit phone numbers. Does not include the country code of '1'. Vaild formats are as follows: 1234567890, 123-456-7890, 123.456.7890, (123) 456-7890, 123 456 7890, (123)456-7890
 * @param {String} string - Phone number user entered 
 * @returns {Boolean} boolean
 */

var isPhoneNumber = function isPhoneNumber(string) {
  try {
